...
<h2>리뷰를 작성해주세요 !!</h2>
   ...
   <input type="hidden" name="user_id" value="<%=user_id %>">
      <table id="r_insret" class="container">
         ...
         <tr>
            <th>한줄평</th>
            <td><textarea name="comments" id="comments" rows="6" cols="40" maxlength="200"></textarea></td>
         </tr>
      </table>
...
$("#submitreview").on("click", function() {
   if (document.getElementById("comments").value == "") {
      ...
      var filteredComments = comments.replace(/</g, ""); // '<' 문자를 빈 문자열로 대체
      document.getElementById("comments").value = filteredComments;
